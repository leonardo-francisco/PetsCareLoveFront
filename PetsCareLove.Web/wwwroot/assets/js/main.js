(function ($) {
    ...
    $(document).ready(function () {
        ...
        if ($('#allProductTable').length) {
            ...
            $('#allProductTable_filter input').addClass('form-control').attr("placeholder", "Buscar...").addClass('form-control-sm');
        ...
        if ($('.email-table').length) {
            ...
            $('.dataTables_filter input').addClass('form-control').attr("placeholder", "Buscar...").addClass('form-control-sm');
        ...
        if ($('#componentDataTable').length) {
            ...
            $('#componentDataTable_filter input').addClass('form-control').attr("placeholder", "Buscar...").addClass('form-control-sm');
        ...
        if ($('#componentDataTable2').length) {
            ...
            $('#componentDataTable2_filter input').addClass('form-control').attr("placeholder", "Buscar...").addClass('form-control-sm');
            $('.dataTables_length').find('select').addClass('form-control form-control-sm px-3');
            $('thead th input[type=checkbox]').on('change', function () {
                if ($(this).is(':checked')) {
                    $(this).parents('.dataTables_wrapper').find('tbody .form-check-input').prop('checked', true);
        ...
        if ($('#componentDataTable3').length) {
            ...
            $('#componentDataTable3_filter input').addClass('form-control').attr("placeholder", "Buscar...").addClass('form-control-sm');
            $('.dataTables_length').find('select').addClass('form-control form-control-sm px-3');
            $('thead th input[type=checkbox]').on('change', function () {
                if ($(this).is(':checked')) {
                    $(this).parents('.dataTables_wrapper').find('tbody .form-check-input').prop('checked', true);
        ...
        if ($('#allEmployeeTable').length) {
            ...
            $('#allEmployeeTable_filter input').addClass('form-control').attr("placeholder", "Buscar...").addClass('form-control-sm');
        ...
        if ($('#companyTable').length) {
            ...
            $('#companyTable_filter input').addClass('form-control').attr("placeholder", "Buscar...").addClass('form-control-sm');
